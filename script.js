...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const skillsBadges = document.querySelectorAll('.skills-card .badge');
    ...
    const actionButtons = document.querySelectorAll('.btn-outline-primary, .btn[class*="btn-link"]');
    actionButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            e.preventDefault();
            showToast('Feature coming soon! This will link to the actual project/certificate.', 'info');
        });
    });
    ...
    // Auto-hide navbar on mobile when link is clicked
